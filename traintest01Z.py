...
import random
"""
本版本为改进encoder只生成一个z,此版本采用01随机变量生成z
"""
# PyTorch package
import torch
...
# 设置生成图像输出文件夹
os.makedirs("./imagestest01Z", exist_ok=True)
# 设置loss曲线图输出文件夹
...
def sample_image(batches_done,labels,test_labeled_imgs):
    ...
    save_image(generated_imgs.data, "./imagestest01Z/%d.png" % batches_done, nrow=10, normalize=True)
