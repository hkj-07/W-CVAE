...
# 设置生成图像输出文件夹
os.makedirs("./imagestest200", exist_ok=True)
# 设置loss曲线图输出文件夹
os.makedirs("./lossfigures200", exist_ok=True)
# 设置数据集文件夹
...
def sample_image(batches_done,labels,test_labeled_imgs):
    ...
    save_image(generated_imgs.data, "./imagestest200/%d.png" % batches_done, nrow=10, normalize=True)
...
def draw_loss(lossMat, batches_done):
    ...
    name = "lossfigures200/Loss " + str(batches_done) + ".png"
